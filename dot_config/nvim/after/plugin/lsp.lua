...
lsp.on_attach(function(client, bufnr)
    ...
    vim.keymap.set('n', 'gi', function() vim.lsp.buf.implementation() end, add_description('lsp show implementation', opts))
    vim.keymap.set('n', 'go', function() vim.lsp.buf.type_definition() end, add_description('lsp show type definition', opts))
    vim.keymap.set('n', 'gr', function() vim.lsp.buf.reference() end, add_description('lsp show reference', opts))
    vim.keymap.set('i', '<C-k>', function() vim.lsp.buf.signature_help() end, add_description('lsp show signature help', opts))
    ...
    vim.keymap.set('n', '<Leader>vws', function() vim.lsp.buf.workspace_symbol() end, add_description('lsp workspace symbol', opts))
